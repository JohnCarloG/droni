...
-- ============================================
-- MISSIONI (10) - INSERIRE DOPO DRONE E PILOTA
-- ============================================
INSERT INTO Missioni (DataMissione, Ora, LatPrelievo, LongPrelievo, LatConsegna, LongConsegna, Valutazione, Commento, IdDrone, IdPilota, Stato) VALUES
('2025-11-19', '10:00', 45.4642000, 9.1900000, 45.4669000, 9.1900000, 8, 'Consegna puntuale', 1, 1, 'completata'),
('2025-11-19', '12:00', 45.4650000, 9.1930000, 45.4690000, 9.1950000, 9, 'Ottima gestione', 2, 2, 'completata'),
('2025-11-20', '09:30', 45.4700000, 9.2000000, 45.4720000, 9.2050000, 7, 'Leggero ritardo', 3, 3, 'completata'),
('2025-11-20', '14:00', 45.4730000, 9.2080000, 45.4750000, 9.2100000, 10, 'Eccellente', 4, 4, 'completata'),
('2025-11-21', '08:00', 45.4600000, 9.1800000, 45.4620000, 9.1850000, 6, NULL, 5, 5, 'completata'),
('2025-11-21', '16:00', 45.4640000, 9.1880000, 45.4665000, 9.1920000, 7, 'Buono', 6, 1, 'completata'),
('2025-11-22', '11:00', 45.4680000, 9.1950000, 45.4700000, 9.1980000, 5, 'Soddisfacente', 7, 2, 'completata'),
('2025-11-22', '13:00', 45.4710000, 9.2030000, 45.4730000, 9.2050000, 9, 'Perfetto', 8, 3, 'completata'),
('2025-11-23', '15:30', 45.4750000, 9.2080000, 45.4770000, 9.2100000, 8, 'Consegna OK', 9, 4, 'completata'),
('2025-11-23', '17:00', 45.4790000, 9.2150000, 45.4810000, 9.2180000, 7, 'Buono', 10, 5, 'completata');

-- ============================================
-- ORDINI (10) - INSERIRE DOPO MISSIONI E UTENTE
-- ============================================
INSERT INTO Ordine (Tipo, PesoTotale, Orario, IndirizzoDestinazione, ID_Missione, ID_Utente) VALUES
('Standard', 1.35, '2025-11-19 10:05:00', 'Via Roma 45, Milano', 1, 1),
('Espresso', 0.90, '2025-11-19 12:10:00', 'Corso Como 12, Milano', 2, 2),
('Standard', 2.10, '2025-11-20 09:35:00', 'Piazza Duomo 8, Milano', 3, 3),
('Standard', 0.80, '2025-11-20 14:05:00', 'Via Torino 33, Milano', 4, 4),
('Espresso', 1.20, '2025-11-21 08:05:00', 'Via Manzoni 22, Milano', 5, 5),
('Standard', 1.75, '2025-11-21 16:10:00', 'Via Furini 7, Milano', 6, 1),
('Standard', 1.30, '2025-11-22 11:10:00', 'Via XX Settembre 15, Milano', 7, 2),
('Espresso', 0.95, '2025-11-22 13:15:00', 'Via Melchiorre Gioia 50, Milano', 8, 3),
('Standard', 1.60, '2025-11-23 15:35:00', 'Viale Monza 28, Milano', 9, 4),
('Espresso', 1.10, '2025-11-23 17:05:00', 'Via Volta 18, Milano', 10, 5);

-- ============================================
-- CONTIENE (26 relazioni) - INSERIRE DOPO ORDINE
-- ============================================
INSERT INTO Contiene (ID_Prodotto, ID_Ordine, Quantita) VALUES
-- Ordine 1
(1, 1, 1),
(2, 1, 1),
-- Ordine 2
...
-- ============================================
-- TRACCIA (50 record) - INSERIRE DOPO MISSIONI
-- ============================================
INSERT INTO Traccia (ID_Drone, ID_Missione, Latitudine, Longitudine, TIMESTAMP) VALUES
-- Missione 1 - Drone 1
(1, 1, 45.4642000, 9.1900000, '2025-11-19 10:00:00'),
(1, 1, 45.4648000, 9.1905000, '2025-11-19 10:02:30'),
(1, 1, 45.4655000, 9.1902000, '2025-11-19 10:05:00'),
(1, 1, 45.4662000, 9.1900000, '2025-11-19 10:07:30'),
(1, 1, 45.4669000, 9.1900000, '2025-11-19 10:10:00'),
-- Missione 2 - Drone 2
(2, 2, 45.4650000, 9.1930000, '2025-11-19 12:00:00'),
(2, 2, 45.4660000, 9.1935000, '2025-11-19 12:03:00'),
(2, 2, 45.4670000, 9.1940000, '2025-11-19 12:06:00'),
(2, 2, 45.4680000, 9.1945000, '2025-11-19 12:09:00'),
(2, 2, 45.4690000, 9.1950000, '2025-11-19 12:12:00'),
-- Missione 3 - Drone 3
(3, 3, 45.4700000, 9.2000000, '2025-11-20 09:30:00'),
(3, 3, 45.4708000, 9.2010000, '2025-11-20 09:33:00'),
(3, 3, 45.4715000, 9.2025000, '2025-11-20 09:36:00'),
(3, 3, 45.4720000, 9.2035000, '2025-11-20 09:39:00'),
(3, 3, 45.4720000, 9.2050000, '2025-11-20 09:42:00'),
-- Missione 4 - Drone 4
(4, 4, 45.4730000, 9.2080000, '2025-11-20 14:00:00'),
(4, 4, 45.4738000, 9.2085000, '2025-11-20 14:02:30'),
(4, 4, 45.4745000, 9.2090000, '2025-11-20 14:05:00'),
(4, 4, 45.4750000, 9.2095000, '2025-11-20 14:07:30'),
(4, 4, 45.4750000, 9.2100000, '2025-11-20 14:10:00'),
-- Missione 5 - Drone 5
(5, 5, 45.4600000, 9.1800000, '2025-11-21 08:00:00'),
(5, 5, 45.4608000, 9.1810000, '2025-11-21 08:03:00'),
(5, 5, 45.4615000, 9.1825000, '2025-11-21 08:06:00'),
(5, 5, 45.4620000, 9.1835000, '2025-11-21 08:09:00'),
(5, 5, 45.4620000, 9.1850000, '2025-11-21 08:12:00'),
-- Missione 6 - Drone 6
(6, 6, 45.4640000, 9.1880000, '2025-11-21 16:00:00'),
(6, 6, 45.4648000, 9.1890000, '2025-11-21 16:02:30'),
(6, 6, 45.4655000, 9.1905000, '2025-11-21 16:05:00'),
(6, 6, 45.4660000, 9.1912000, '2025-11-21 16:07:30'),
(6, 6, 45.4665000, 9.1920000, '2025-11-21 16:10:00'),
-- Missione 7 - Drone 7
(7, 7, 45.4680000, 9.1950000, '2025-11-22 11:00:00'),
(7, 7, 45.4686000, 9.1960000, '2025-11-22 11:03:00'),
(7, 7, 45.4692000, 9.1968000, '2025-11-22 11:06:00'),
(7, 7, 45.4698000, 9.1975000, '2025-11-22 11:09:00'),
(7, 7, 45.4700000, 9.1980000, '2025-11-22 11:12:00'),
-- Missione 8 - Drone 8
(8, 8, 45.4710000, 9.2030000, '2025-11-22 13:00:00'),
(8, 8, 45.4717000, 9.2035000, '2025-11-22 13:02:30'),
(8, 8, 45.4723000, 9.2040000, '2025-11-22 13:05:00'),
(8, 8, 45.4727000, 9.2045000, '2025-11-22 13:07:30'),
(8, 8, 45.4730000, 9.2050000, '2025-11-22 13:10:00'),
-- Missione 9 - Drone 9
(9, 9, 45.4750000, 9.2080000, '2025-11-23 15:30:00'),
(9, 9, 45.4758000, 9.2085000, '2025-11-23 15:33:00'),
(9, 9, 45.4764000, 9.2090000, '2025-11-23 15:36:00'),
(9, 9, 45.4770000, 9.2095000, '2025-11-23 15:39:00'),
(9, 9, 45.4770000, 9.2100000, '2025-11-23 15:42:00'),
-- Missione 10 - Drone 10
(10, 10, 45.4790000, 9.2150000, '2025-11-23 17:00:00'),
(10, 10, 45.4798000, 9.2158000, '2025-11-23 17:03:00'),
(10, 10, 45.4804000, 9.2165000, '2025-11-23 17:06:00'),
(10, 10, 45.4810000, 9.2175000, '2025-11-23 17:09:00'),
(10, 10, 45.4810000, 9.2180000, '2025-11-23 17:12:00');

-- ============================================
-- FINE SCRIPT
-- ============================================
-- Totale record creati:
-- Piloti: 5
-- Droni: 10
-- Utenti: 5
-- Prodotti: 100
